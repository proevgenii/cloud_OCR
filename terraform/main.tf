      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:logs:eu-central-1:${local.account_id}:*/*",
            "arn:aws:dynamodb:eu-central-1:${local.account_id}:*/*"
          ]
        }
      ]
    })
      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:ecs:eu-central-1:${local.account_id}:*/*",
            "arn:aws:cloudwatch:eu-central-1:${local.account_id}:*/*"
          ]
        }
      ]
    })
...
resource "aws_ecs_task_definition" "ecs_task_definition" {
  family                = "${var.service_name}-ecs-ocr-app"
...
[
  {
    ...
    "logConfiguration": {
      ...
      "options": {
        ...
        "awslogs-stream-prefix": "ecs-ocr-app"
      }
    },
    "mountPoints": [
      {
